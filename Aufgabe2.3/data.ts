namespace Aufgabe2_3 { //die konkreten Daten 
    //Rumpfauswahlmoeglichkeiten 
    export let canvasRumpf: HTMLCanvasElement = <HTMLCanvasElement> document.getElementById("Canvas_Rumpf");
    export let canvasSegel: HTMLCanvasElement = <HTMLCanvasElement> document.getElementById("Canvas_Segel");
    export let canvasSteuer: HTMLCanvasElement = <HTMLCanvasElement> document.getElementById("Canvas_Steuer");
    export let alleRuempfe: Rumpf[] = [];


    let rumpf1: Rumpf = {laenge: 200, name: "Wellenbrecher", form: canvasRumpf.getContext("2d")};
    rumpf1.form.fillStyle = "brown";
    rumpf1.form.fillRect(10, 150, rumpf1.laenge, 60);
    alleRuempfe.push(rumpf1); 

    let rumpf2: Rumpf = {laenge: 400, name: "Morgenröte", form: canvasRumpf.getContext("2d")};
    rumpf2.form.fillStyle = "brown";
    rumpf2.form.fillRect(250, 150, rumpf2.laenge, 60);
    alleRuempfe.push(rumpf2);

    let rumpf3: Rumpf = {laenge: 150, name: "Arielle", form: canvasRumpf.getContext("2d")};
