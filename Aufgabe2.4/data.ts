namespace Aufgabe2_4 {
    export let auswahl: AlleAuswahlmöglichkeiten = {
        ruempfe: [
            {image: "Bilddateien/Wellenbrecher.PNG", laenge: "200m", name: "Wellenbrecher" },
            {image: "Bilddateien/Morgenröte.PNG", laenge: "400m", name: "Wellenbrecher" },
            {image: "Bilddateien/Arielle.PNG", laenge: "150m", name: "Wellenbrecher" }
        ],
        segel: [
